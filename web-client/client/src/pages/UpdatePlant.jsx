...
const UpdatePlant = () => {
  ...
  const fetchPlant = async () => {
    try {
      ...
      // If plant has an image, set it as preview
      if (plant.image) {
        setPreviewUrl(plant.image);
      }
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      await axios.put(`http://localhost:3001/updatePlant/${id}`, {
        ...formData,
        image: imageUrl
      });
  ...
  return (
    <Layout>
      <div className="relative bg-[#D9E7CB] rounded-lg p-8">
        ...
        <h1 className="text-3xl font-bold text-[#2E2E2E] mb-6">Edit Plant</h1>
                    ...
                    >
                      <div className="text-center">
                        ...
                        <p className="mt-1 text-sm text-gray-600">
                          {selectedFile ? selectedFile.name : 'Click to upload a new plant image'}
                        </p>
                      </div>
                    </label>
                  </div>
