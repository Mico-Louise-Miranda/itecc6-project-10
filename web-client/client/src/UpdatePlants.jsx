...
function UpdatePlants() {
    ...
    const handleUpdate = (e) => {
        ...
        axios.put(`http://localhost:3001/updatePlant/${id}`, {
            name, desc, sunreq, waterneeds, soiltype, image
        })
            .then(result => {
                console.log(result);
                setLoading(false);
    ...
    return (
        <div className="min-h-screen bg-gray-50">
            ...
            <div className="container mx-auto p-6">
                <div className="mb-8">
                    <h2 className="text-2xl font-bold text-gray-800 mb-2">Update Plant</h2>
                    <p className="text-gray-600">Edit the details of your plant</p>
                </div>
